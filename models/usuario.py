...
MAILGUN_DOMAIN = 'sandboxd5909302fa0948c6a8ebabbba5d8694e.mailgun.org'
MAILGUN_API_KEY = 'c892dd711f42ec8b74e2632c4c13997d-28d78af2-c972ab08'
FROM_TITLE = 'NO-REPLY'
...
class UserModel(banco.Model):
    ...
    ativado  = banco.Column(banco.Boolean, default=False, nullable=False)
    ...
    def send_confirmation_email(self):
         # retorna http://127.0.0.1:5000/confirmacao/{user_id}
